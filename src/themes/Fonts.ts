...
export default class Fonts {
    ...
    // Fonts;
    static Regular = (size: number = Fonts.Size.normal, color = APP_PRIMARY_TEXT) => {
        return Fonts.font(Fonts.Type.Regular, size, color);
    };
    static Bold = (size: number = Fonts.Size.normal, color = APP_PRIMARY_TEXT) => {
    ...
    static Light = (size: number = Fonts.Size.normal, color = APP_PRIMARY_TEXT) => {
        return Fonts.font(Fonts.Type.Light, size, color);
    };

    static Medium = (size: number = Fonts.Size.normal, color = APP_PRIMARY_TEXT) => {
        return Fonts.font(Fonts.Type.Medium, size, color);
    };
}
